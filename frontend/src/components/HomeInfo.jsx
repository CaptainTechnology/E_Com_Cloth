    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700">
                ...
                <div>
                    <img
                        src={assets.return_img}
                        className="w-12 m-auto mb-5"
                        alt=""
                    />
                    <p className="font-semibold">24/7 Customer Support</p>
                    <p className="text-gray-400">We're here for you all day and night</p>
                </div>
                <div>
                    <img
                         src={assets.customer_sup}
                        className="w-12 m-auto mb-5"
                        alt=""
                    />
                    <p className="font-semibold">Secure Payment Options</p>
                    <p className="text-gray-400">We ensure your payment information is secure</p>
                </div>
            </div>
